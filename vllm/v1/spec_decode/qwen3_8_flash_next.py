...
class Qwen3_8FlashNextMTPProposer(EagleProposer):
    """Speculative decoding proposer for Qwen3.8-Flash-Next MTP."""
    ...
    def initialize_attn_backend(
        ...
        if num_mtp_layers != 1:
            raise NotImplementedError(
                "Qwen3.8-Flash-Next MTP proposer only supports one MTP layer"
            )
        ...
        assert len(main_layers) == 1, (
            "Qwen3.8-Flash-Next MTP requires exactly one main cache owner"
        )
...
__all__ = ["Qwen3_8FlashNextMTPProposer"]
